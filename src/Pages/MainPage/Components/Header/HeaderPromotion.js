            ...
            <div className="grid-item">
                <div className="headerIcons">
                    <a className={`headerIcons-link`} href="#">
                        <svg className={` searchIcon`} width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a className={`headerIcons-link`} href="#">
                        <svg className={` basketIcon`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
